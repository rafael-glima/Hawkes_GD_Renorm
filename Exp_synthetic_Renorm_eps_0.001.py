...
for i in range(1,5):
	...
	for j in range(0,n_of_seq):
		...
		llh_GD_QEXP_Renorm_a = np.append(llh_GD_QEXP,QEXP_Param['llh_renorm_a'])
		llh_GD_RAY_Renorm_gamma = np.append(llh_GD_QEXP,QEXP_Param['llh_renorm_gamma'])
		...
		llh_GD_RAY_Renorm_eta = np.append(llh_GD_QEXP,QEXP_Param['llh_renorm_eta'])
...
f = open('Exp_Synthetic_Renorm_T1000_eps_0.001.txt','w')
